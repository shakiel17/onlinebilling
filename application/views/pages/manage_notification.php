        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card card-primary shadow">
              ...
              <div class="card-body">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?=base_url('manage_notification');?>">All</a></li>
                <?php
                $courses=$this->Billing_model->getAllCourse();
                foreach($courses as $cor){
                  ?>
                    <li class="breadcrumb-item"><a href="<?=base_url('search_notify_course/'.$cor['id']);?>"><?=$cor['description'];?></a></li>
                  <?php
                }
                ?>                
                <!-- <li class="breadcrumb-item active">Top Navigation</li> -->
          ...
          <div class="col-lg-12">
            <div class="card card-success shadow">
              ...
              <div class="card-body">
                ...
                foreach($courses as $cor){
                  ?>
                    <li class="breadcrumb-item"><a href="<?=base_url('search_notify_grade/'.$cor['id']);?>"><?=$cor['description'];?></a></li>
                  <?php
                }
                ?>                
                <!-- <li class="breadcrumb-item active">Top Navigation</li> -->
