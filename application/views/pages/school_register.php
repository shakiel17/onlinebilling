...
<head>
  ...
  <title>Online Billing System | School Register</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>School Registration</b></a>
    </div>
    <div class="card-body">
      ...
      <form action="<?=base_url('registration');?>" method="POST">
        ...
        <div class="input-group mb-3">
          <textarea name="address" class="form-control" placeholder="School Address"></textarea>
          <div class="input-group-append">
            <div class="input-group-text">
    ...
    ?>
    <div class="alert alert-danger"><?=$this->session->remarks;?></div>
    <?php
    }
    ?>
    <!-- /.form-box -->
