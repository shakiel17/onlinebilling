            ...
            <div class="card card-primary shadow">
              ...
              <div class="card-body">
                ...
                foreach($courses as $cor){
                  ?>
                    <li class="breadcrumb-item"><a href="<?=base_url('search_billing_course/'.$cor['id']);?>"><?=$cor['description'];?></a></li>
                  <?php
                }
                ?>                
                <!-- <li class="breadcrumb-item active">Top Navigation</li> -->
          ...
          <div class="col-lg-12">
            <div class="card card-success shadow">
              ...
              <div class="card-body">
                ...
                foreach($courses as $cor){
                  ?>
                    <li class="breadcrumb-item"><a href="<?=base_url('search_billing_grade/'.$cor['id']);?>"><?=$cor['description'];?></a></li>
                  <?php
                }
                ?>                
                <!-- <li class="breadcrumb-item active">Top Navigation</li> -->
